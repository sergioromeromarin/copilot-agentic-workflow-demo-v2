import { AgentResult, Finding, ToolPolicy, HandoffTask } from '../types.js';

export async function runQaIntegrationAgent(policy: ToolPolicy, repoRoot: string, receivedHandoffs: HandoffTask[] = []): Promise<AgentResult> {
